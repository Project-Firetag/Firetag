        ...
        <>
            <header className="h-24 z-[99999] w-full bg-[#161c24] border-b-2 border-[#00a3ac] fixed flex items-center justify-between">
                <button
                    ...
                    className={`z-[100001] w-[140px] h-[80px] ${dimensions.x < 730 ? "image-container" : ""}`}
                >
                ...
                <h1 className={`text-white z-[100000] fixed w-screen text-center ${dimensions.x < 490 ? "text-3xl" : "text-6xl"} font-libre uppercase`}>Firetag</h1>
                <div id="right" className={`flex ${dimensions.x < 730 ? "flex-col w-auto items-end mr-1" : "flex-row w-72 items-center"} justify-evenly z-[100002]`}>
                    <button 
                    ...
                    <h4 className={`text-white ${dimensions.x < 730 ? "mr-1 mt-2" : "mr-5"}`}>Cont - 9909099099</h4>
                </div>
            </header>
        </>
    )
